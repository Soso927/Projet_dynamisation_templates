...
<head>
    ...
    <title>Les beaux stades d'Europe</title>
</head>
<body>
...
<header>
        <div id="header-title">
            <h1 class="display-1 ms-4">Les beaux stade d'Europe</h1>
            <h3 class="ms-4">Tous les stades que je voudrais visiter en Europe</h3>
        </div>
